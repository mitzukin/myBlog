...
const Footer = () => {
  return (
    <div>
      ...
      <footer className="flex flex-col items-center pb-5 mt-20 text-center text-white bg-neutral-900">
        <div className="container px-6 pt-6 mx-auto">
          <div className="flex justify-center mb-6">
            ...
            <a
              href="#!"
              type="button"
              classNameName="m-1 leading-normal text-white uppercase transition duration-150 ease-in-out border-2 border-white rounded-full h-9 w-9 hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
              data-te-ripple-init
              data-te-ripple-color="light"
            >
              <svg
        ...
        <div classNameName="w-full p-4 text-center bg-opacity-20 text-sm ">
          <div className="grid items-center justify-center gap-4 gird-cols-1 md:grid-cols-3 ">
            ...
            <div className="relative md:mb-6" data-te-input-wrapper-init>
              <input
                type="text"
                className="peer block min-h-[auto] w-full rounded border-0 bg-secondary px-3 py-[0.32rem] leading-[1.6] text-neutral-200 outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                id="exampleFormControlInput1"
                placeholder="Email address"
              />
              <label
                for="exampleFormControlInput1"
                className="pointer-events-none font-Roboto absolute text-sm  left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-200 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-neutral-200 peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-neutral-200"
              >
                Email address
              </label>
            </div>
          ...
          <a className="text-sm text-white " href="https://tw-elements.com/">
            {" "}
            © 2023 Music In One
          </a>
        </div>
