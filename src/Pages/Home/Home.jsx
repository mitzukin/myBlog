...
const Home = () => {
  ...
  return (
    <div>
      <div className="p-0 pt-16 mx-0 lg:p-0" id="Home">
        <div className="flex flex-col mb-10 bg-white md::mx-0 xl:mx-32 md:flex-col xl:flex-row">
          <div className="flex-1 p-5 lg:mt-10 lg:p-10 xl:ml-32 ">
            <h1
              className="pt-5 text-6xl font-semibold lg:text-8xl font-Roboto text-primary xl:mt-16 lg:mt-10"
              data-aos="fade-up"
            ...
            <p
              className="p-2 mt-5 font-semibold text-secondary"
              data-aos="fade-up"
              data-aos-anchor-placement="top-bottom"
            >
            ...
            <div
              className="flex gap-2 pb-32 mt-3 ml-2"
              data-aos="fade-up"
              data-aos-anchor-placement="top-bottom"
            >
          ...
          <div
            className="flex-1 hidden mx-auto mt-0 lg:mt-20 w-96 md:hidden xl:block"
            data-aos="fade-up"
            data-aos-anchor-placement="top-bottom"
          >
        ...
        <div className="p-10 bg-primary">
          ...
          <h1
            className="text-4xl font-bold text-center text-pwhite font-Roboto"
            data-aos="fade-up"
          ...
          <p
            className="px-5 mt-2 mb-10 text-center text-pwhite font-Roboto"
            data-aos="fade-up"
            data-aos-duration="1000"
          >
        ...
        <div class="flex flex-col gap-2 mx-0 md:px-4 lg:flex-row bg-pwhite pt-10 xl:px-10">
          <div className="p-4 lg:p-0 w-7/10">
            <div className="grid grid-cols-1 gap-2 mx-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:ml-10 xl:grid-cols-4">
              <div
              ...
              <div className="" data-aos="fade-up" data-aos-duration="1500">
                <Card
                  image="https://nextshark.b-cdn.net/wp-content/uploads/2022/12/AJ-RAFAEL_SIMU-LIU.jpg?width=768&auto_optimize=medium"
            ...
            <h1
              className="px-5 pb-5 mt-10 text-lg font-semibold text-center"
              data-aos="fade-up"
              data-aos-duration="1500"
            >
          ...
          <div
            class="lg:w-3/10 w-full block lg:block p-2 "
            data-aos="fade-right"
            data-aos-duration="1500"
          >
            <Sidebar />
    ...
    >
      ...
      <div className="lg:mx-56">
        <h1
          className="mb-10 text-2xl font-bold text-center md:text-4xl font-Roboto"
          data-aos="fade-up"
          data-aos-duration="1500"
        >
          <span className="text-3xl md:text-6xl">'' </span>Music is the divine
          expression of the human soul, composing emotions that words alone
          cannot capture.<span className="text-3xl md:text-6xl">'' </span>
          <span className="text-xl font-normal">- Ludwig van Beethoven</span>
        </h1>
      </div>
      <Footer />
    </div>
